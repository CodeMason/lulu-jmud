 ...
 * back, arm, chest, etc or places in a room: floor, chestOfDrawers. Created on
 * 25NOV08
 * @author Dave Loman
 * @version 0.1
 */
...
public abstract class AbstractItemContainerDef extends AbstractItemDef {
   ...
   public final boolean add(final Targetable targetAdding,
   ...
   public final boolean remove(final Targetable targetAdding,
         final ItemContainer ic, final Item i) {
      // perform a specific check
